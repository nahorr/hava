...
@section('content')
    ...
    <section class="container g-pt-100 g-pb-50">
      <div class="u-heading-v6-2 text-center g-mb-60">
          ...
          <h2 class="h1 u-heading-v6__title g-brd-black g-color-black g-font-weight-600 mb-0">Digit Gas</h2>
        </div>
      <div class="g-pos-rel">
      <!-- Info Blocks -->
          ...
          <div class="col-lg-6">
            ...
            <article class="h-100 text-left text-lg-right u-block-hover g-flex-middle g-color-white--hover g-bg-gray-dark-v1 g-transition-0_3 g-py-70 g-px-30 g-pr-150--lg">
              ...
              <div class="g-flex-middle-item g-pos-rel g-z-index-1">
                ...
                <p class="g-color-white-opacity-0_7 mb-0"> Digit Gas is an intensely renowned LPG and allied products handling and distribution company set up by a group of technically-inclined professionals that are heartily desirous about filling the yawning gap in the sector and create innovative changes that will positively alter the skyline of domestic gas handling and distribution in Nigeria.</p>
              </div>
            </article>
            <!-- End Article -->
          </div>
