  ...
  <section class="container g-pt-100 g-pb-40">
    <div class="row justify-content-between">
      <div class="col-md-7 g-mb-60">
        ...
        <p class="g-color-gray-dark-v3 g-font-size-16">Digit Gas is happy to provide you with more information, answer any questions you may have and create an effective solution for your software and data analysis needs.</p>
      ...
      <div class="col-md-4">
        <h1 class="g-font-weight-300 mb-5">Digit Gas Ltd</h1>
        ...
        <div class="mb-4">
          ...
          <p class="g-color-gray-dark-v4">Email: <a class="g-color-gray-dark-v2" href="#!">support@digitgas.com</a>
          </p>
        </div>
