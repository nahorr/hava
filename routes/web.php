...
Route::get('/productsandservices', 'HomePublic\HomeController@productsAndServices')->name('pands');
Route::get('/safetytips', 'HomePublic\HomeController@safetyTips')->name('safetytips');
